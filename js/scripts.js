...
$(document).ready(function(e) {
	...
	$('#filterOptions a.category').click(function(e) {
        ...
        if (filterType == 'all') {
            $('.item-p').animate({height: '0', width: '0', margin: '0'}, 500);
            $('.item-p').animate({width: '298'}, 0);
            $('.item-p').animate({height: '284', margin: '15px 0 30px 25px'}, 500);
        } else {
            var items = {};
            ...
            $('.item-p').animate({height: '0', width: '0', margin: '0'}, 500);
            $('.selected').animate({width: '298'}, 0);
            $('.selected').animate({height: '284', width: '298', margin: '15px 0 30px 25px'}, 500);
